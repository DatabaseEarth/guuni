<div class="page_bai_viet">
    ...
    <section class="phan_trang container">
        <div class="khung-phan_trang">
            <a class="<?=($page<=1)?'none':''?>" href="?mod=page&act=baiViet&page=<?=$page-1?>"><i class="fa-solid fa-angles-left"></i></a>
            <?php for($i=1; $i<=$sotrang;$i++): ?>
                <a class="<?=($page==$i)?'chinh':''?>" href="?mod=page&act=baiViet&page=<?=$i?>"><?=$i?></a>
            <?php endfor; ?>
            <a class="<?=($page>=$sotrang)?'none':''?>" href="?mod=page&act=baiViet&page=<?=$page+1?>"><i class="fa-solid fa-angles-right"></i></a>
        </div>
    </section>
</div>